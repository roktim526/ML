...
def predict_band_gap(input_formula):
    try:
        ...
        try:
            model = joblib.load('D:\Document\GNN\Model\ML\Phy410\bandgap_model.joblib')
            scaler = joblib.load('D:\Document\GNN\Model\ML\Phy410\BgApp\scaler.joblib')
            feature_columns = joblib.load('D:\Document\GNN\Model\ML\Phy410\BgApp\feature_columns.joblib')
